...
\begin{body}
    \vspace{18pt}
    \begin{jobdescriptionlist}{Software Engineer - Full Stack}{Knotis Inc.}{April 2014 - October 2nd 2015}
        ...
        \item Managed and updated Apache, uWSGI, and Nginx configurations.
...
\begin{body}
    ...
    \medskip
    \textbf{Probabilistic WiFi Geolocation} - Figaro (Scala), Javascript and CouchDB
